...
data = dict(
    ...
    train=dict(
        ...
        B_img_dir = 'Potsdam_RGB_DA/img_dir/train',
        B_split = 'Potsdam_RGB_DA/train.txt',
        pipeline=train_pipeline),
    # target domain for validation
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='Potsdam_RGB_DA/img_dir/val',
        ann_dir='Potsdam_RGB_DA/ann_dir/val', 
        split='Potsdam_RGB_DA/val.txt',
